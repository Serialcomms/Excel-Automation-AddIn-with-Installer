...
2 Select [View > Custom Actions](/SCREENSHOTS/CUSTOM_ACTIONS_ADD_NEW.png) and add the Primary Output to each of the [four categories shown](/DOCUMENTS/CUSTOM_ACTIONA_AUTO_INSTALLER.png)
